        ...
        <div className="font-poppins">
            ...
            <div className="m-5">
                ...
                <div className="p-4 grid grid-cols-2">
                    <h2 className="flex justify-start font-bold text-[1.5em]"><span className="text-[blue] ">Magic</span>Search</h2>
                ...
                />
                    ...
                    </div>
                    {
                        ...
                        (
                            ...
                            <h2 className="text-[1.5em] tracking-[0.050em]">Time Available:<span>{list.time_starts}</span>-<span>{list.time_ends}</span></h2>
                            {/* call type begins */}
