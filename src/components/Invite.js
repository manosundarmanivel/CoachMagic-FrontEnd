...
const Invite = ()=>
{
    return(
        <div>
            <Header/>
            <h1 className="font-bold font-sans text-[30px] p-8 text-black">Invite Sent</h1>
            <div className="shadow-inner ml-10 mr-10 rounded-full">
                <h1 className="font-semibold pl-60 pt-3 text-[25px]">Choose Your Domain</h1>
