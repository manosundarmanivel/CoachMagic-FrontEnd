      ...
      <div className="bg-purple-300 p-10 rounded-3xl flex">
        <div className=" bg-white flex rounded-3xl ">
          <div className=" flex flex-col  bg-white   rounded-3xl">
            <div className="flex flex-col ml-2 items-center font-poppins">
              <img
                // src={bropic}
                alt="Profile"
            ...
            /> */}
              ...
              <div>
                <div class="grid grid-flow-row py-3 px-8 mr-2 grid-cols-5 ...">
                  <div className="max-w-md p-4 bg-gray-100 rounded-lg shadow-lg py-5 px-4 border-2 border-blue-500 col-span-2">
                    <h1 className="text-2xl font-bold mb-4">
                      Email
