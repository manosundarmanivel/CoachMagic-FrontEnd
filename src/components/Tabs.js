      ...
      <TabContext value={value}>
        ...
        <TabPanel value="1">
            <div>
                ...
                <img className=' m-2 h-[100px] w-[100px] rounded-full object-cover' src={image}/>
                <InputText type='file'  onChange={(event)=>{
                    setImage(URL.createObjectURL(event.target.files[0]));
                }} />
                <Divider sx={{marginTop:'25px'}}/>
                <div className='flex'>
                    <div className='p-2'>
                        <h1 className='font-[16px] pb-2 pt-1'>Full name</h1>
                        <input className='bg-[#FAFBFC] border border-gray-400 rounded-lg p-2 w-[400px]' placeholder='Please enter the full name'/>
                        <h1 className='font-[16px] pb-2 pt-1'>Full name</h1>
                        <input className='bg-[#FAFBFC] border border-gray-400 rounded-lg p-2 w-[400px]' placeholder='Please enter the full name'/>
                        <h1 className='font-[16px] pb-2 pt-1'>Full name</h1>
                        <input className='bg-[#FAFBFC] border border-gray-400 rounded-lg p-2 w-[400px]' placeholder='Please enter the full name'/>
